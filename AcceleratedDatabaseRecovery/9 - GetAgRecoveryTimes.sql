...
LogDate,
CASE 
	WHEN ErrorText LIKE '%Accelerated%' THEN 'AcceleratedAg'
	WHEN ErrorText LIKE '%Regular%' THEN 'RegularAg'
END AS DatabaseName, 
...
FROM #errorlog
WHERE ErrorText LIKE '%AcceleratedAg%'
OR ErrorText LIKE '%RegularAg%';
